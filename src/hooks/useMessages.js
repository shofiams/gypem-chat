...
export const useRoomMedia = (roomId) => {
  // Menggunakan `useMessagesByRoom` dari branch utama sebagai sumber data
  // 'data' di-rename menjadi 'messages' agar sesuai dengan logika hook ini
  const { data: messages, loading, error, refetch } = useMessagesByRoom(roomId);
  
